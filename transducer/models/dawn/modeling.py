...
from transducer.models.dawn.config import DawnModelConfig, Wav2Vec2BertConfig, Wav2VecConfig
from transducer.models.dawn.encoder import Wav2Vec2BertModel, Wav2VecModel
from transducer.models.dawn.joiner import SimpleJoiner
from transducer.models.dawn.predictor import RNNPredictor


class DawnModel(BaseModel, GenerationMixin):
    def __init__(self, vocab_size: int, config: DawnModelConfig):
