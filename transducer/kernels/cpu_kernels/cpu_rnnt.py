...
# https://github.com/NVIDIA-NeMo/NeMo/blob/main/nemo/collections/asr/parts/numba/rnnt_loss/utils/cpu_utils/cpu_rnnt.py
...
class CPURNNT:
    ...
    def cost_and_grad(
        ...
        return RNNTStatus.RNNT_STATUS_SUCCESS
