# https://github.com/NVIDIA-NeMo/NeMo/blob/main/nemo/collections/asr/parts/numba/rnnt_loss/utils/cuda_utils/reduce.py
import enum
import math
...
from transducer.kernels.utils import dtype, warp_size
